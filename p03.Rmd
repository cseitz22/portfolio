...
```{r make-plot-prettier}

z<-plot_usmap(data=ranks, values = "health_care", color="purple")+
  labs(title = "State Rankings in Health Care",
       caption = "Lighter colors are for higher ranks.")+ 
  scale_fill_continuous(
    low = "white", high = "purple", name = "Health Care Rank")+
