...
```
2.89% of trials were trimmed from the adult data set. 
...
```
6.07% of trials were trimmed from the ounger child data set
...
df_mod <- subset(space_anova, select=c(id, high_prob, absent, low_prob))
