...
dcast(space_anova,ID~relative_hp_dist,value.var='rts')
...
Test whether the high-prob location and the average across low-prob locations were significantly different. 

```{r t-test for high and low conditions only}
...
space_anova$low_prob <- rowMeans(as.numeric(space_anova, na.rm=TRUE))
