...
This figure displays the mean response times depending on the location of the distractor relative to the high probability location.

Question: why does adding the ylim get rid of the bar. 

```{r - graph 1 - distractor location effect on rt}
ggplot(data = dist_means, aes(x = relative_hp_dist, y = mean_rts)) +
  geom_bar(stat = "identity", fill="#9E7E38") +
...
```
Create a new data frame with the average RT for each relative distractor location per participant. 
