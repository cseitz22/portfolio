...
```{r add_column_for_target's_distance_from_the_high_probability_location}
...
ggplot(data = target_means, aes(x = relative_target, y = mean_rts)) +
  ...
  labs(caption = "An ANOVA test shows a difference in RT depending on target location, F(4,80)=XXX, p<.001.")
